        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p id="cookie-banner-description" className="text-sm text-gray-600">
              We use cookies to enable essential services and to understand how visitors interact with our site. By clicking Accept, you agree to our use of cookies for analytics and support.{' '}
